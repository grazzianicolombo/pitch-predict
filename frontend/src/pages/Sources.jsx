...
const SOURCES_META = {
  ...
  forbes: {
    name: 'Forbes Brasil', url: 'forbes.com.br',
    via: 'Tavily', category: 'Negócios & Finanças', status: 'ativo', coverage: 'Complementar',
    fields: ['rankings', 'executivos', 'empresas de alto crescimento'],
    highlight: 'Busca corporativa search-first (A8) · foco em C-level e movimentações',
    canPdf: false,
  },
  infomoney: {
    name: 'InfoMoney', url: 'infomoney.com.br',
    via: 'Tavily', category: 'Negócios & Finanças', status: 'ativo', coverage: 'Complementar',
    fields: ['resultados financeiros', 'sinais de mercado de capital'],
    highlight: 'Busca corporativa search-first (A8)',
    canPdf: false,
  },
  istoedinheiro: {
    name: 'IstoÉ Dinheiro', url: 'istoedinheiro.com.br',
    via: 'Tavily', category: 'Negócios & Finanças', status: 'ativo', coverage: 'Complementar',
    fields: ['negócios', 'finanças', 'reestruturações'],
    highlight: 'Busca corporativa search-first (A8)',
    canPdf: false,
  },
  scopen: {
